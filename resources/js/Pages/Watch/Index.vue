            ...
            <main class=" flex-1 py-10  px-5 sm:px-10 ">
                ...
                <section class="mt-9">
                    <div class="flex items-center justify-between">
                        <span class="font-semibold text-gray-700 text-base dark:text-white">Movies</span>
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5 ">
                        ...
                        <MovieCard  v-for="movie in movies.data" v-bind:key="movie.id" :movie="movie" ></MovieCard>
                    </div>
